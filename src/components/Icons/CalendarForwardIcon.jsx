export default function CalendarForwardIcon() {
  return (
    <svg fill="#ffffff" height="25px" width="25px" version="1.1" id="Layer_1" viewBox="0 0 330.002 330.002" stroke="#ffffff" cursor="pointer">
      <path
        id="XMLID_226_"
